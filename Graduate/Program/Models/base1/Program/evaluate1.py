...
train_dir = os.path.join(base_dir, 'new/train/base1/2345/all') # ここ
...
test_dir = os.path.join(base_dir, 'new/test')

test_datagen = ImageDataGenerator(rescale=1.0 / 255)

model = load_model('/media/masaki/627D-A8B0/graduatepaper/data/Models/base1/modellist/2345/loss/weights.89-0.17-0.93-0.22-0.92.hdf5')
# model.summary()

f = open('/media/masaki/627D-A8B0/graduatepaper/data/Models/base1/result/2345/resultSample.txt', 'w', encoding='UTF-8')
...
sns.heatmap(cm)
plt.savefig('/media/masaki/627D-A8B0/graduatepaper/data/Models/base1/result/2345/sklearn_confusion_matrix_sample.png')
...
plt.grid()
plt.savefig('/media/masaki/627D-A8B0/graduatepaper/data/Models/base1/result/2345/sklearn_roc_curve_sample.png')
...
with open('/media/masaki/627D-A8B0/graduatepaper/data/Models/base1/result/2345/testSample.txt', 'w') as f:
    f.write('true:')
    f.write(y_true)
    f.write('\n')
    f.write('pred:')
