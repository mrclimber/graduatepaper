...
train_dir = os.path.join(base_dir, 'new/train/HighLow/2345/select') # ここ
...
model = load_model('/media/masaki/627D-A8B0/graduatepaper/data/Models/HighLow/modellist/2345/acc/weights.24-0.35-0.83-0.30-0.92.hdf5')
model.summary()

f = open('/media/masaki/627D-A8B0/graduatepaper/data/Models/HighLow/result/2345/acc/resultSample.txt', 'w', encoding='UTF-8')
...
sns.heatmap(cm)
plt.savefig('/media/masaki/627D-A8B0/graduatepaper/data/Models/HighLow/result/2345/acc/sklearn_confusion_matrix_sample.png')
...
plt.grid()
plt.savefig('/media/masaki/627D-A8B0/graduatepaper/data/Models/HighLow/result/2345/acc/sklearn_roc_curve_sample.png')
...
with open('/media/masaki/627D-A8B0/graduatepaper/data/Models/HighLow/result/2345/acc/testSample.txt', 'w') as f:
    f.write('true:')
    f.write(y_true)
    f.write('\n')
    f.write('pred:')
