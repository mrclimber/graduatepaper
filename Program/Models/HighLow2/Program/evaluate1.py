...
train_dir = os.path.join(base_dir, 'new/train/HighLow2/2345/select') # ここ
...
model = load_model('/home/masaki/graduatepaper/data/Models/HighLow2/modellist/2345/acc/weights.20-0.65-0.60-0.62-0.73.hdf5')
model.summary()

f = open('/home/masaki/graduatepaper/data/Models/HighLow2/result/2345/acc/resultSample.txt', 'w', encoding='UTF-8')
...
sns.heatmap(cm)
plt.savefig('/home/masaki/graduatepaper/data/Models/HighLow2/result/2345/acc/sklearn_confusion_matrix_sample.png')
...
plt.grid()
plt.savefig('/home/masaki/graduatepaper/data/Models/HighLow2/result/2345/acc/sklearn_roc_curve_sample.png')
...
with open('/home/masaki/graduatepaper/data/Models/HighLow2/result/2345/acc/testSample.txt', 'w') as f:
    f.write('true:')
    f.write(y_true)
    f.write('\n')
    f.write('pred:')
