...
f = open('/home/masaki/graduatepaper/data/Models/HighLow2/result/2345/result.txt', 'w', encoding='UTF-8') # ここ

classes = ['good','bad']
nb_classes = len(classes)
batch_size_for_data_generator = 20

AmpPha_dir = "/home/masaki/graduatepaper/data/model"

train_dir = os.path.join(AmpPha_dir, 'new/train/HighLow2/2345/select') # ここ
validation_dir = os.path.join(AmpPha_dir, 'new/validation/1') # ここ
test_dir = os.path.join(AmpPha_dir, 'new/test') # ここ
...
fpath_acc = '/home/masaki/graduatepaper/data/Models/HighLow2/modellist/2345/acc/weights.{epoch:02d}-{loss:.2f}-{acc:.2f}-{val_loss:.2f}-{val_acc:.2f}.hdf5'
...
fpath_loss = '/home/masaki/graduatepaper/data/Models/HighLow2/modellist/2345/loss/weights.{epoch:02d}-{loss:.2f}-{acc:.2f}-{val_loss:.2f}-{val_acc:.2f}.hdf5'
...
# hdf5_file = os.path.join(AmpPha_dir, 'model.h5')
...
plt.legend()
plt.savefig('/home/masaki/graduatepaper/data/Models/HighLow2/result/2345/accuracy.png') #ここ
...
plt.legend()
plt.savefig('/home/masaki/graduatepaper/data/Models/HighLow2/result/2345/loss.png') # ここ
