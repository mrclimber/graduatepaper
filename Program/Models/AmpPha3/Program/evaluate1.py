...
train_dir = os.path.join(base_dir, 'new/train/AmpPha3/2345/select') # ここ
...
model = load_model('/home/masaki/graduatepaper/data/Models/AmpPha3/modellist/2345/acc/weights.49-0.43-0.77-0.25-0.92.hdf5')
model.summary()

f = open('/home/masaki/graduatepaper/data/Models/AmpPha3/result/2345/acc/resultSample.txt', 'w', encoding='UTF-8')
...
sns.heatmap(cm)
plt.savefig('/home/masaki/graduatepaper/data/Models/AmpPha3/result/2345/acc/sklearn_confusion_matrix_sample.png')
...
plt.grid()
plt.savefig('/home/masaki/graduatepaper/data/Models/AmpPha3/result/2345/acc/sklearn_roc_curve_sample.png')
...
with open('/home/masaki/graduatepaper/data/Models/AmpPha3/result/2345/acc/testSample.txt', 'w') as f:
    f.write('true:')
    f.write(y_true)
    f.write('\n')
    f.write('pred:')
