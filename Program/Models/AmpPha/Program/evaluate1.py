...
train_dir = os.path.join(base_dir, 'new/train/AmpPha/2345/select') # ここ
...
model = load_model('/media/masaki/627D-A8B0/graduatepaper/data/Models/AmpPha/modellist/2345/acc/weights.16-0.45-0.79-0.30-0.89.hdf5')
model.summary()

f = open('/media/masaki/627D-A8B0/graduatepaper/data/Models/AmpPha/result/2345/acc/resultSample.txt', 'w', encoding='UTF-8')
...
sns.heatmap(cm)
plt.savefig('/media/masaki/627D-A8B0/graduatepaper/data/Models/AmpPha/result/2345/acc/sklearn_confusion_matrix_sample.png')
...
plt.grid()
plt.savefig('/media/masaki/627D-A8B0/graduatepaper/data/Models/AmpPha/result/2345/acc/sklearn_roc_curve_sample.png')
...
with open('/media/masaki/627D-A8B0/graduatepaper/data/Models/AmpPha/result/2345/acc/testSample.txt', 'w') as f:
    f.write('true:')
    f.write(y_true)
    f.write('\n')
    f.write('pred:')
