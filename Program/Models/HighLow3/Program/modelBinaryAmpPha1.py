...
f = open('/home/masaki/graduatepaper/data/Models/HighLow3/result/2345/result.txt', 'w', encoding='UTF-8') # ここ
...
train_dir = os.path.join(AmpPha_dir, 'new/train/HighLow3/2345/select') # ここ
...
fpath_acc = '/home/masaki/graduatepaper/data/Models/HighLow3/modellist/2345/acc/weights.{epoch:02d}-{loss:.2f}-{acc:.2f}-{val_loss:.2f}-{val_acc:.2f}.hdf5'
...
fpath_loss = '/home/masaki/graduatepaper/data/Models/HighLow3/modellist/2345/loss/weights.{epoch:02d}-{loss:.2f}-{acc:.2f}-{val_loss:.2f}-{val_acc:.2f}.hdf5'
...
plt.legend()
plt.savefig('/home/masaki/graduatepaper/data/Models/HighLow3/result/2345/accuracy.png') #ここ
...
plt.legend()
plt.savefig('/home/masaki/graduatepaper/data/Models/HighLow3/result/2345/loss.png') # ここ
