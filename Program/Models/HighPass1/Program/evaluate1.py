...
train_dir = os.path.join(base_dir, 'new/train/HighPass1/2345/select') # ここ
...
model = load_model('/home/masaki/graduatepaper/data/Models/HighPass1/modellist/2345/acc/weights.86-0.19-0.92-0.21-0.94.hdf5')
model.summary()

f = open('/home/masaki/graduatepaper/data/Models/HighPass1/result/2345/acc/resultSample.txt', 'w', encoding='UTF-8')
...
for i in range(132):
    ...
    if b_ehime != "None":
        for j in range(5):
            j_new = str(j+1)
            filename_ehime = '/home/masaki/graduatepaper/data/model/new/alltest_new/MRIT2画像_愛媛_test_' + i_new_ehime + '_' + j_new + '.tif'
...
for i in range(132):
    ...
    if b_shizuoka != "None":
        for j in range(5):
            j_new = str(j+1)
            filename_shizuoka = '/home/masaki/graduatepaper/data/model/new/alltest_new/MRIT2画像_静岡_test_' + i_new_shizuoka + '_' + j_new + '.tif'
...
for length in lenehime:
    ...
    for j in range(5):
        path = "/home/masaki/graduatepaper/data/model/new/alltest_new/" # パスを格納
        j_new = str(j+1)
...
sns.heatmap(cm)
plt.savefig('/home/masaki/graduatepaper/data/Models/HighPass1/result/2345/acc/sklearn_confusion_matrix_sample.png')
...
plt.grid()
plt.savefig('/home/masaki/graduatepaper/data/Models/HighPass1/result/2345/acc/sklearn_roc_curve_sample.png')
...
with open('/home/masaki/graduatepaper/data/Models/HighPass1/result/2345/acc/testSample.txt', 'w') as f:
    f.write('true:')
    f.write(y_true)
    f.write('\n')
    f.write('pred:')
